...
function Home(props) {
  ...
  const games = useMemo(
    () => [
      ...
      ["FC ZWK Nebra", "SV Kretzschau", new Date("October 5, 2025 14:00")],
      [
        "SV Kretzschau",
        "SSC Weißenfels III",
        new Date("October 19, 2025 15:00"),
      ],
      ["SC Naumburg II", "SV Kretzschau", new Date("October 26, 2025 14:00")],
      [
        "SV Kretzschau",
      ...
      ["SV Spora", "SV Kretzschau", new Date("November 22, 2025 13:00")],
      [
        "Baumersrodaer SV",
        "SV Kretzschau",
        new Date("December 6, 2025 13:00"),
      ],
      ["SG Nessa / Teuchern", "SV Kretzschau", new Date("March 1, 2026 14:00")],
      [
        "SV Kretzschau",
        "ESV Herrengosserstedt",
      ...
      ["SV Kretzschau", "FC ZWK Nebra", new Date("April 12, 2026 15:00")],
      [
        "SSC Weißenfels III",
        "SV Kretzschau",
        new Date("April 19, 2026 15:00"),
      ],
      ["SV Kretzschau", "SC Naumburg II", new Date("April 26, 2026 15:00")],
      [
        "VfB Scharnhorst Großgörschen",
        "SV Kretzschau",
      ...
      ["SV Kretzschau", "SV Spora", new Date("May 31, 2026 15:00")],
      [
        "SG Blau-Weiß Bad Kösen",
        "SV Kretzschau",
        new Date("June 7, 2026 15:00"),
      ],
      ["SV Kretzschau", "Baumersrodaer SV", new Date("June 14, 2026 14:00")],
    ],
    []
  );
  useEffect(() => {
    ...
    <>
      ...
      <section className="hero-section py-3 py-md-4">
        <div className="d-flex justify-content-center">
          {isMobile ? <TeamworkQuote /> : <MyImageGallery hero />}
        </div>
      </section>
