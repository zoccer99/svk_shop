      ...
      <div class="mb-3 text-center d-flex flex-column">
        ...
        <div className="Player">
          ...
          <h5 className="text-center font-weight-light">
            ...
            (Sponsor), Nico Balschun, Christian Koschik, Quentin Bernstein, Udo-
            Thomas Schirdewahn, Luca Jena, Elias Just, Manuel Lages, Christoph
            Scholz (SF), Etienne- Noel Kalkofen, Christoph Freyer, Andre Barth,
            Erik Dobierzin (Trainer)
          </h5>
          <h3 className="text-center font-italic">
            Vorn von links nach rechts:
          </h3>
          <h5 className="text-center font-weight-light">
            Matthias Scholle, Philipp Seifert, Leon Gottschild, Markus Schumann,
            Christopher Pauli, Andreas Ludwig, Julius- Niclas Pacholski, Philipp
            Schmidt, Daniel Piehl, Marc- Andre Preuß, Nils Jaeger, Christian
            Gebert (Betreuer)
            <br />
          </h5>
